...
function lvg_scripts()
{
    ...
    wp_enqueue_style('lvg-theme-style', get_template_directory_uri() . '/assets/css/style.css', [], '1.0.1');
    ...
    wp_enqueue_script('lvg-script', get_template_directory_uri() . '/assets/js/script.js', array(), '1.0.1', true);
